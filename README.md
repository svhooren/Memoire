...
Les **secteurs des bureaux de vote de 2012 et 2017** à Paris sont exploités sous format GeoJSON. Les deux proviennent d'OpenData. Dans les deux cas ils reprennent les polygônes géographiques des bureaux de vote et le nombre d'électeurs inscrits par bureaux. Les bureaux de vote de 2012 sont au nombre de 867 tandis que ceux de 2017 sont au nombre de 896. Les secteurs IRIS sont également utilisés, ils proviennent de DataGouv\footnote{https://www.data.gouv.fr/fr/datasets/contours-iris/}. 
...
Ces écarts indiquent que le vote de classe joue encore un rôle important mais qu'il n'est plus le seul à expliquer les choix électoraux. D'autres phénomènes entrent en jeu, pour beaucoup l'\textbf{effet de voisinage} est un élément important. Celui-ci peut s'observer dans des quartiers où une classe sociale est surreprésentée, mais qui vote différemment de ce qui est attendu, suite au voisinage d'un quartier de composition sociologique différente. Comme l'avait démontré Klatzmann J. avec les ouvriers dans un univers bourgeois qui ont tendance à voter libéral. \citep{david_pillars_2011}


### Le vote scindé des classes intermédiaires
La classe moyenne connaît une division en son sein, celle-ci est dûe à la société actuelle de post-abondance comme l'expliquait Chauvel L. (2006). Cette \textbf{division interne} s'accompagne de l'individualisation de la classe laissant ainsi présager un vote scindé au sein de la classe moyenne. \citep{garnier_violence_2010,pincon-charlot_sociologie_2003,chauvel_les_2006} Afin d'analyser le vote de la classe intermédiaire, il importe de la définir. Comme l'explique Van Hamme G., les limites de cette classe son incertaines, elle se situe entre la bourgeoisie qui détient les moyens de productions, et les salariés de l'industrie et des services qui effectuent les tâches d'exécution. \citep{van_hamme_social_2012} C'est sur base de cette définition que sont choisies les classes soiales au sein de ce travail :
\begin{itemize}[label=\textbullet]
    \item Les classes aisées sont les artisans, commerçants et chefs d'entreprise.
    \item Les classes populaires sont les employés, les ouvriers et les chômeurs.
    \item Les agriculteurs exploitants, extrêmement minimes voir nuls au sein des données de Paris intra-muros ne sont pas pris en compte.
    \item Les retraités n'appartenant à aucune classe ne sont pas répertoriés.\footnote{Remarquons toutefois le rôle important des quartiers où ils sont surreprésentés à Paris intra-muros, dans l'électorat de François Fillon (voir Table \ref{regf})}
\end{itemize}
...
\hline
 & CS3 & CS4 \\ \hline
François Fillon & + *** & -  *** \\ \hline
Benoît Hamon & - *** & + *** \\ \hline
Marine Le Pen & - *** & + ** \\ \hline
Emmanuel Macron & + *** & + * \\ \hline
Jean-Luc Mélenchon & - *** & + *** \\ \hline
Petits candidats & - *** & +*** \\ \hline
\end{tabular}
\caption{Récapitulatif des régressions linéaires multiples des CS3 et CS4}
\label{tab:recapreg}
\end{table}
